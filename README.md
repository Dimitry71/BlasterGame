...
У цьому проєкті використовується стандарт **Doxygen** для створення автоматичної документації з C++ коду.

### 📋 Правила

- Використовуйте `/** */` або `///` для опису класів, функцій і змінних.
- Опис має включати:
  - короткий опис
  - параметри (`@param`)
  - повернуте значення (`@return`)

### 🔧 Приклад

```cpp
/**
 * @brief Активує режим спринту.
 * @param bIsSprinting Чи активувати спринт
 */
