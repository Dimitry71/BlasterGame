...
void UCombatComponent::FireProjeectileWeapon()
{
	if(EquippedWeapon && Character)
	{
...
void UCombatComponent::UpdateAmmoValues()
{
	...
	PlayerController = PlayerController == nullptr ? Cast<ABlasterPlayerController>(PlayerController) : PlayerController;
	if(PlayerController)
	{
...
void UCombatComponent::InitializeCarriedAmmo()
{
	...
	CarriedAmmoMap.Emplace(EWeaponType::EWT_AK74,StartingAK74Ammo);
...
void UCombatComponent::PlayEquipWeaponSound(AWeapon* WeaponToSound)
{
	if(Character && WeaponToSound && WeaponToSound->EquipSound)
	{
		UGameplayStatics::PlaySoundAtLocation(
				this,
				WeaponToSound->EquipSound,
